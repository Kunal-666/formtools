    ...
    faqs: [
      {
        ...
        answer:
          "Upload your file, click the resize button, preview the processed image, and download it. The tool adjusts the image to stay close to the 20KB target for online form uploads.",
      },
      {
        question: "Where is a 20KB image required?",
        answer:
          "A 20KB photo or signature is commonly requested in SSC, railway, banking, scholarship, and other government-related forms where the upload size is tightly controlled.",
      },
      {
        question: "Is this image resizer free?",
        answer:
          "Yes, this resize image for govt form tool is free to use in your browser and is meant for quick form preparation without extra software.",
      },
    ],
  },
  "resize-image-30kb": {
    ...
    faqs: [
      {
        ...
        answer:
          "Upload your image, run the 30KB resize tool, check the preview, and download the output. This is the quickest way to compress image for online form requirements near 30KB.",
      },
      {
        question: "Why do govt forms ask for small image sizes?",
        answer:
          "Government and recruitment portals often keep file limits low so uploads stay lightweight and uniform across thousands of applicants.",
      },
      {
        question: "Can I use this for SSC and banking forms?",
        answer:
          "Yes, it is suitable for SSC, banking, railway, and other recruitment applications whenever the portal demands a photo under a specific KB limit.",
      },
    ],
  },
  "resize-image-50kb": {
    slug: "resize-image-50kb",
    ...
    faqs: [
      {
        ...
        answer:
          "Upload the image, click resize, and download the processed file. The tool aims to keep the output close to the 50KB requirement used in many govt forms.",
      },
      {
        question: "What is required photo size for SSC form?",
        answer:
          "SSC photo requirements can vary by notification, but many candidates need a small compressed image and often search for photo under 50kb or signature size for SSC before uploading.",
      },
      {
        question: "Is this tool free for govt form preparation?",
        answer:
          "Yes, the tool is free and designed specifically for quick image preparation for online forms and recruitment portals.",
      },
    ],
  },
  "resize-image-100kb": {
    slug: "resize-image-100kb",
    ...
    faqs: [
      {
        ...
        answer:
          "Upload your picture, click the resize button, and download the processed image. The tool is built to create a file close to 100KB for portal submission.",
      },
      {
        question: "Is 100KB accepted in govt forms?",
        answer:
          "Some online forms and application portals allow images up to 100KB, but you should always verify the exact notification or portal instruction before uploading.",
      },
      {
        question: "Can I resize image for govt form on mobile?",
        answer:
          "Yes, the page is mobile-friendly and lets you compress image for online form uploads directly from your browser.",
      },
    ],
  },
  "photo-under-50kb-ssc": {
    slug: "photo-under-50kb-ssc",
    ...
    faqs: [
      {
        ...
        answer:
          "Upload your photo, process it with the 50KB preset, preview the result, and download it. This is a quick way to prepare an SSC-compatible photo file.",
      },
      {
        question: "What is the required photo size for SSC?",
        answer:
          "The exact SSC image rule can change by notification, but many users need a compressed passport-style image and a matching signature size for SSC uploads.",
      },
      {
        question: "Can I use this for other govt forms too?",
        answer:
          "Yes, this page also works well for railway, banking, police, teaching, and other online applications that require a photo under 50KB.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer:
          "Upload the signature image, click resize, preview the processed version, and download the result. This helps create a small signature file for online form submission.",
      },
      {
        question: "What is the signature size for SSC?",
        answer:
          "Signature size for SSC can vary by notification, but many candidates need a very small file in KB terms, which is why a dedicated signature under 20KB tool is useful.",
      },
      {
        question: "Is this useful for govt forms and exam portals?",
        answer:
          "Yes, it is meant for SSC, railway, banking, scholarship, and other portals where a low-size signature upload is mandatory.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer:
          "Upload your passport-style photo, process it with the tool, preview the result, and download the resized image for form upload.",
      },
      {
        question: "Can I create photo under 50kb for govt form here?",
        answer:
          "Yes, this page uses a 50KB preset that works well when you need a passport-style photo under a common government portal size limit.",
      },
      {
        question: "Is this passport photo maker free?",
        answer:
          "Yes, it is free to use in the browser and helps applicants prepare passport-style photos for government and exam portals.",
      },
    ],
  },
};
